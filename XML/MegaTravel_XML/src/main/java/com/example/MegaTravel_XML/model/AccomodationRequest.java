...
@XmlRootElement(name = "AccomodationRequest", namespace = "http://megatravel.com/accommodation")
public class AccomodationRequest {

    @XmlElement(name = "agent_id", namespace = "http://megatravel.com/accommodation")
